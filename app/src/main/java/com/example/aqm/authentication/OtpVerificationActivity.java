package com.example.aqm.authentication;
...
import com.example.aqm.maincontroller.BottomNavBarActivity;
import com.example.aqm.reportissue.helpers.MailSender;
...
public class OtpVerificationActivity extends AppCompatActivity {
    ...
    private void sendEmailOTPMessage() {
        Thread sender = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    MailSender sender = new MailSender("1emmanuelbarasa340@gmail.com", "13251325!");
